  ...
  pages: {
    ...
    channels: {
      ...
      placeholders: {
        ...
        accountAgent: 'Leave empty to keep this account unbound',
        accountPrimaryModel: 'Leave empty to use the default model chain',
        accountFallbackModels: 'Select fallback models for this account',
        accountId: 'Enter a new accountId, e.g. default / bot-2',
        accountField: 'Enter {field}',
        secret: 'Enter new value (leave blank to keep)',
      },
      accountAgentBound: 'This account is bound to: {agent}',
      accountAgentEmpty: 'This account has no explicit agent binding yet.',
      accountAgentUnbound: 'No bound agent',
      accountPrimaryModelBound: 'Primary model: {model}',
      accountPrimaryModelEmpty: 'Primary model: use default',
      accountFallbackModelsBound: 'Fallback models: {models}',
      accountFallbackModelsEmpty: 'Fallback models: none',
      missingAgent: 'missing agent',
      missingModel: 'missing model',
      agentLoadFailed: 'Failed to load agent list: {error}',
